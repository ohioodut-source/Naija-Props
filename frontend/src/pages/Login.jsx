        ...
        <div className="container" style={{ padding: '8rem 2rem', maxWidth: '500px' }}>
            <div className="glass" style={{ padding: '3rem' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="button" onClick={handleGoogleLogin} className="btn btn-outline" style={{ width: '100%', padding: '0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem' }}>
